...
// Connect to MongoDB using the cloud



mongoose.connect(process.env.MONGODB_URI_CLOUD || 'mongodb+srv://elsawilom:Omonzogbe2004.@chillflix.xgtulmm.mongodb.net/', {
...
app.use(
  session({
    store: MongoStore.create({
      mongoUrl: process.env.MONGODB_URI_CLOUD || 'mongodb+srv://elsawilom:Omonzogbe2004.@chillflix.xgtulmm.mongodb.net/',
...
//for local databse connection 

// 1. Connect to MongoDB using mongoose
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/project-copy', {
...
app.use(
  session({
    store: MongoStore.create({
      mongoUrl: process.env.MONGODB_URI || 'mongodb://localhost:27017/project-copy',
      collectionName: 'sessions',
      ttl: 14 * 24 * 60 * 60 // 14 days
    }),
